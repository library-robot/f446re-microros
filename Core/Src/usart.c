...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(F103re_TX_GPIO_Port, F103re_TX_Pin);

    HAL_GPIO_DeInit(F103re_RX_GPIO_Port, F103re_RX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, Micro_ROS_TX_Pin|Micro_ROS_RX_Pin);
